        ...
        <div className="space-y-8 animate-fade-in" style={{ animationDelay: "200ms" }}>
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              HireMind ("we", "us", "our", or "Company") operates the HireMind website and application. This page
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              HireMind uses the collected data for various purposes including: providing and maintaining our Service,
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              If you have any questions about this Privacy Policy, please contact us at privacy@hiremind.com
            </p>
          </section>
        </div>
      </main>
