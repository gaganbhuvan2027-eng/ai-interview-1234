    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="mb-16 animate-fade-in">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">About HireMind</h1>
        ...
        <section className="mb-16 animate-fade-in" style={{ animationDelay: "100ms" }}>
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            At HireMind, we believe that everyone deserves access to world-class interview preparation. Our mission is
        ...
        <section className="animate-fade-in" style={{ animationDelay: "400ms" }}>
          <h2 className="text-3xl font-bold mb-8">Why Choose HireMind?</h2>
